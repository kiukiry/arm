...
m_visitLabel->setText("День приезда мастера:");
...
m_viewRequestsButton = new QPushButton("Просмотреть заявки", this);
m_viewRequestsButton->setGeometry(10, 310, 310, 30);
QPushButton *backButton = new QPushButton("Назад", this);
backButton->setGeometry(330, 310, 150, 30);
connect(backButton, &QPushButton::clicked, this, [this]() {
    setCentralWidget(m_createButton);
});
...
connect(m_viewRequestsButton, &QPushButton::clicked, this, &MainWindow::switchToRequestsTable);
